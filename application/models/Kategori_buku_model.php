...
class Kategori_buku_model extends CI_Model {
	...
	//function update berfungsi merubah data ke table kategori buku di database
	...
	//function delete berfungsi menghapus data dari table kategori buku di database
